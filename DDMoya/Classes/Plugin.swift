...
public protocol PluginType {
    ...
    func didReceive(_ result: Result<DDMoya.Response, MoyaError>, target: TargetType)

    /// Called to modify a result before completion.
    func process(_ result: Result<DDMoya.Response, MoyaError>, target: TargetType) -> Result<DDMoya.Response, MoyaError>
}
...
public extension PluginType {
    ...
    func willSend(_ request: RequestType, target: TargetType) { }
    func didReceive(_ result: Result<DDMoya.Response, MoyaError>, target: TargetType) { }
    func process(_ result: Result<DDMoya.Response, MoyaError>, target: TargetType) -> Result<DDMoya.Response, MoyaError> { return result }
}
